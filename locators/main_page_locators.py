...
class MainPageLocators:
    SECTION_INGREDIENT_DETAILS = By.XPATH, ".//div[contains(@class, 'Modal_modal_opened')]"
    ...
    BUTTON_ORDERS_FEED_LINK = By.XPATH, "//p[text()='Лента Заказов']"
    UNIQUE_ORDER_ELEMENT_LOCATOR = By.XPATH, "//section[contains(@class, 'BurgerConstructor')]"
