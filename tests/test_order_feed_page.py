...
class TestOrderPage:
    ...
    @allure.description("""
        ...
        """)
    def test_order_feed_page_create_order_global_counter_increased(self, login_page, create_user, order_feed_page):
        ...
        order_feed_page.is_on_order_page()
    ...
    @allure.description("""
        ...
        """)
    def test_order_feed_page_create_order_today_counter_increased(self, login_page, create_user, order_feed_page):
        email, password = create_user()
        login_page.open()        
        main_page = login_page.auth(email, password)
        order_feed = order_feed_page.navigate_to_orders_feed()
    ...
    @allure.description("""
        ...
        """)
    def test_order_feed_page_create_order_progress_list_contains_order(self, login_page, create_user, order_feed_page):
        email, password = create_user()
        login_page.open()        
        main_page = login_page.auth(email, password)
